...
/* Adapted from CDT */
public class FastNescPartitionScanner implements IPartitionTokenScanner, INCPartitions {
	...
	private final IToken[] fTokens= new IToken[] {
		new Token(null),
		new Token(NC_SINGLE_LINE_COMMENT),
		new Token(NC_MULTI_LINE_COMMENT),
		new Token(NC_CHARACTER),
		new Token(NC_STRING),
		new Token(NC_STRING),
		new Token(NC_PREPROCESSOR),
		new Token(NC_MULTI_LINE_COMMENT),
		new Token(NC_PREPROCESSOR),
	};
	...
	public FastNescPartitionScanner() {
	}
	...
	private static int getState(String contentType) {
		if (contentType == null) {
			return CCODE;
		} else if (contentType.equals(NC_SINGLE_LINE_COMMENT)) {
			return SINGLE_LINE_COMMENT;
		} else if (contentType.equals(NC_MULTI_LINE_COMMENT)) {
			return MULTI_LINE_COMMENT;
		} else if (contentType.equals(NC_STRING)) {
			return STRING;
		} else if (contentType.equals(NC_CHARACTER)) {
			return CHARACTER;
		} else if (contentType.equals(NC_PREPROCESSOR)) {
			return PREPROCESSOR;
		} else {
			return CCODE;
		}
